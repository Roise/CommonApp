package com.tistory.deque.kotlinmvvmsample.advise.view
...
import com.tistory.deque.kotlinmvvmsample.advise.base.BaseKotlinActivity
...
//    BaseKotlinActivity<ActivityMainBinding, MainViewModel>() {
...
//                Log.e("jun","main observe = " + document.image_url)
